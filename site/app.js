...
const I18N = {
  fr: {
    ...
    f6_text: "Sandbox macOS, mot de passe d'application stocké dans le Keychain local. Aucune donnée ne transite par un tiers.",
  ...
  en: {
    ...
    f6_text: "macOS sandbox, app password stored in the local Keychain. No data ever passes through a third party.",
